import { View, Text, BackHandler, Image, ScrollView, Dimensions, StatusBar, SafeAreaView } from 'react-native'
                    ...
                    <ScrollView
                        ...
                        {netBankingList.length > 0 ? (
                            <View style={{ marginHorizontal: 16, backgroundColor: 'white', borderColor: "#F1F1F1", borderWidth: 1, borderRadius: 12, marginBottom: 32 }}>
                                <PaymentSelectorView providerList={netBankingList} onProceedForward={onProceedForward} errorImage={require("../assets/images/ic_netbanking_semi_bold.png")} onClickRadio={(selectedInstrumentValue) => onClickRadioButton(selectedInstrumentValue)}/>
                            </View>
                        ) : (
