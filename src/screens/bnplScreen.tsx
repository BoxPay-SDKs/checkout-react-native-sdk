import { View, Text, BackHandler, Image, ScrollView, StatusBar, SafeAreaView } from 'react-native'
                    ...
                    <ScrollView
                        ...
                        {bnplList.length > 0 ? (
                            <View style={{ marginHorizontal: 16, backgroundColor: 'white', borderColor: "#F1F1F1", borderWidth: 1, borderRadius: 12, marginVertical: 16 }}>
                                <PaymentSelectorView providerList = {bnplList} onProceedForward={onProceedForward} errorImage={require("../assets/images/ic_bnpl_semi_bold.png")} onClickRadio={(selectedInstrumentValue) => onClickRadioButton(selectedInstrumentValue)}/>
                            </View>
                        ) : (
