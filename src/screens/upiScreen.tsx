...
const UpiScreen: React.FC<UpiScreenProps> = ({ isUpiIntentVisible, isUpiCollectVisible, handleUpiPayment, handleCollectPayment, savedUpiArray, onClickRadio }) => {
    ...
    return (
        <View>
            ...
            <PaymentSelectorView providerList={savedUpiArray} onProceedForward={(displayValue, instrumentValue,type) => handleCollectPayment(displayValue, instrumentValue, type)} errorImage={require("../assets/images/ic_upi.png")} isLastUsed={false} onClickRadio={(selectedValue) => {
                setSelectedIntent(null)
                ...
                {isUpiIntentVisible && (
                    <View>
                        ...
                        {(selectedIntent !== null && selectedIntent !== "") && (
                            <Pressable style={[styles.buttonContainer, { backgroundColor: checkoutDetails.brandColor }]} onPress={() => handleUpiPayment(selectedIntent)}>
