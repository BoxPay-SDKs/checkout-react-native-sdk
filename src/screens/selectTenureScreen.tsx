...
const SelectTenureScreen = ({ bankName, cardType, emiModel, bankUrl, onbackPress, onProceedForward }: SelectTenureProps) => {
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: '#F5F6FB' }}>
            <Header onBackPress={onbackPress} showDesc={true} showSecure={false} text='Select Tenure' />
            <View style={{
                ...
                <View style={{ flexDirection: 'row', paddingHorizontal: 12, paddingVertical: 16, alignItems: 'center' }}>
                    <View style={{
                        width: 28,
                        height: 28,
                    ...
                    <Text style={{ fontFamily: 'Poppins-SemiBold', fontSize: 14, paddingStart: 8 }}>{bankName} | {cardType} EMI</Text>
                </View>
