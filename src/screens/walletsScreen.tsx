                    ...
                    <ScrollView
                        ...
                        {walletList.length > 0 ? (
                            <View style={{ marginHorizontal: 16, backgroundColor: 'white', borderColor: "#F1F1F1", borderWidth: 1, borderRadius: 12, marginBottom: 32 }}>
                                <PaymentSelectorView providerList={walletList} onProceedForward={onProceedForward} errorImage={require("../../../assets/images/ic_wallet_semi_bold.png")} onClickRadio={(selectedInstrumentValue) => onClickRadioButton(selectedInstrumentValue)}/>
                            </View>
                        ) : (
