            ...
            {loading ? (
                ...
                <View style={{ flex: 1, backgroundColor: 'white' }}>
                    ...
                    <TextInput
                        mode='outlined'
                        label={
                            <Text style={{ fontSize: 16, fontFamily: 'Poppins-Regular', color: cardNumberFocused ? '#2D2B32' : (cardNumberText != "" && cardNumberText != null) ? '#2D2B32' : '#ADACB0' }}>Card Number</Text>
                        }
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: 16, marginTop: 16 }}>
                        <View style={{ flex: 1, flexDirection: 'column' }}>
                            <TextInput
                                mode='outlined'
                                label={
                                    <Text style={{ fontSize: 16, fontFamily: 'Poppins-Regular', color: cardExpiryFocused ? '#2D2B32' : (cardExpiryText != "" && cardExpiryText != null) ? '#2D2B32' : '#ADACB0' }}>Expiry (MM/YY)</Text>
                                }
                        ...
                        <View style={{ flex: 1, flexDirection: 'column', marginStart: 16 }}>
                            <TextInput
                                mode='outlined'
                                label={
                                    <Text style={{ fontSize: 16, fontFamily: 'Poppins-Regular', color: cardCvvFocused ? '#2D2B32' : (cardCvvText != "" && cardCvvText != null) ? '#2D2B32' : '#ADACB0' }}>CVV</Text>
                                }
                                value={cardCvvText || ''}
                                onChangeText={(it) => {
                    ...
                    <TextInput
                        mode='outlined'
                        label={
                            <Text style={{ fontSize: 16, fontFamily: 'Poppins-Regular', color: cardHolderNameFocused ? '#2D2B32' : (cardHolderNameText != "" && cardHolderNameText != null) ? '#2D2B32' : '#ADACB0' }}>Name on the Card</Text>
                        }
                    ...
                    {shopperToken != null && shopperToken != "" && (
                        ...
                        mode='outlined'
                        label={
                            <Text style={{ fontSize: 16, fontFamily: 'Poppins-Regular', color: cardNickNameFocused ? '#2D2B32' : (cardNickNameText != "" && cardNickNameText != null) ? '#2D2B32' : '#ADACB0' }}>Card NickName (for easy identification)</Text>
                        }
                    ...
                    {shopperToken != null && shopperToken != "" && (
                        <View style = {{flexDirection:'row',marginTop:10, alignItems:'center', paddingLeft:10}}>
                        <Checkbox
                        ...
                        />
                        <Text style={{ color: '#2D2B32', fontSize: 14, fontFamily: 'Poppins-Regular', marginLeft: 8}}>Save this card as per RBI guidelines.</Text>
                        <Pressable onPress={()=> {
                            setKnowMoreDialog(true)
                        }} style = {{marginLeft:4}}>
                            <Text style={{ color: checkoutDetails.brandColor, fontSize: 12, fontFamily: 'Poppins-SemiBold', textDecorationLine:'underline'}}>Know more</Text>
                        </Pressable>
                    </View>
                    )
                    }
