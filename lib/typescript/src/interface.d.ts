...
export declare enum ConfigurationOptions {
...
export declare enum UIConfigurationOptions {
...
export type InstrumentDetails = UPIIntentPayload | CardTokenPayload | UPICollectPayload | UPIQRPayload;
