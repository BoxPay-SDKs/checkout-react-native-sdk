...
import { View, Text, BackHandler, AppState, Image, ScrollView, Alert } from 'react-native'; // Added ScrollView
...
import { loadBoxpayFonts } from "../components/fontFamily.js";
import { setUserDataHandler, setUserDataHandlerToDefault, userDataHandler } from "../sharedContext/userdataHandler.js";
import { APIStatus, AnalyticsEvents, UIConfigurationOptions } from "../interface.js";
import { checkoutDetailsHandler, setCheckoutDetailsHandler, setCheckOutDetailsHandlerToDefault } from "../sharedContext/checkoutDetailsHandler.js";
...
import { formatAddress, getPhoneNumberCodeAndCountryName, useCountdown } from "../utility.js";
import fetchSurCharge from "../postRequest/fetchSurcharge.js";
import fetchInstantOffer from "../postRequest/fetchInstantOffer.js";
import ApplyCouponCard from "../components/applyCouponCard.js";
...
const MainScreen = ({
  ...
  const [appliedSurchargeAmount, setAppliedSurchargeAmount] = useState(0);
  ...
  const handleUpiCollectPayment = async (upiId, instrumentRef, type, isSICheckBoxClicked) => {
  ...
  const getInstantOfferDetails = async amount => {
      ...
      case APIStatus.Success:
        {
          const data = response.data;
          try {
            const offer = appliedOffer == null ? data?.[0] ?? null : data.find(it => it.code === appliedOffer.code) ?? null;
  ...
  return /*#__PURE__*/_jsxs(View, {
    ...
    children: [isFirstLoading ? /*#__PURE__*/_jsx(ShimmerView, {}) : /*#__PURE__*/_jsx(ScrollView, {
      ...
      children: /*#__PURE__*/_jsxs(View, {
        ...
        children: [/*#__PURE__*/_jsx(Header, {
          ...
          children: [/*#__PURE__*/_jsx(View, {
            ...
            children: /*#__PURE__*/_jsx(Text, {
              style: [styles.headingText, {
                fontFamily: checkoutDetailsHandler.checkoutDetails.fontFamily.semiBold
              }],
            ...
            children: /*#__PURE__*/_jsx(PaymentSelectorView, {
              ...
              onProceedForward: (displayValue, instrumentValue, type) => handleUpiCollectPayment(displayValue, instrumentValue, type, false),
          ...
          handleCollectPayment: (displayValue, instrumentValue, type) => handleUpiCollectPayment(displayValue, instrumentValue, type, false),
          ...
          children: [/*#__PURE__*/_jsx(Text, {
            ...
            children: /*#__PURE__*/_jsx(SavedCardComponentView, {
              ...
              onProceedForward: (instrumentValue, isSICheckBoxClicked) => {
        ...
        }), instantOfferList.length != 0 && /*#__PURE__*/_jsxs(View, {
          style: {
            marginVertical: 8,
            marginHorizontal: 16,
            paddingBottom: 16
          ...
          children: [/*#__PURE__*/_jsx(Text, {
            ...
            onClickApply: code => {
              const offer = instantOfferList.find(it => it.code === code) ?? null;
              setAppliedOffer(offer);
        ...
        }), checkoutDetailsHandler.checkoutDetails.isOrderItemDetailsVisible && /*#__PURE__*/_jsxs(View, {
          children: [/*#__PURE__*/_jsx(Text, {
            style: [styles.headingText, {
              fontFamily: checkoutDetailsHandler.checkoutDetails.fontFamily.semiBold
            }],
          ...
          children: [/*#__PURE__*/_jsx(Text, {
            style: [styles.footerText, {
              fontFamily: checkoutDetailsHandler.checkoutDetails.fontFamily.medium
            }],
            children: "Secured by"
          }), /*#__PURE__*/_jsx(Image, {
